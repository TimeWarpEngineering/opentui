...
- **Source**: `packages/core/src/3d.ts`
- **Target**: `source/timewarp-tui-core/3d.cs`
- **Phase**: 0
...
- [Depth 1 - Direct](../../scripts/dependency-graphs/3d-depth-1.svg)
- [Depth 2 - Extended](../../scripts/dependency-graphs/3d-depth-2.svg)
...
cd packages/core && bun test 3d.test.ts

# Run C# tests (after conversion)
cd test/timewarp-tui-core-tests
dotnet fixie --tests "3d.*"
```
